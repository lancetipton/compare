 ...
 */
export const useIncrementZIndex = () => {
  const [z] = useState(() => {
    return inc()
  })
  useEffect(() => {
 ...
 */
export const useIncrementZIndexIfVisible = (visible: boolean) => {
 ...
 */
export const useCurrentZIndex = (offset = 1) => {
 ...
 */
export const useLatestZIndex = (offset = 1) => {
...
export const watchLatestZIndex = (handler: (z: number) => void, offset = 1) => {
